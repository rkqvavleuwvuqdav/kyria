...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   _______,   MO(_ADJUST), ADJ, _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT_RSFT_ENT,
              _______, _______, LOWER, SPC_NUM, LCMD_RIGHT, MO(_MACRO), SPC_NUM, MO(_RAISE),  _______, _______
    ),
    ...
    [_RAISE] = LAYOUT(
      ...
      _______, _______, _______, _______, KC_MUTE, KC_VOLD, _______, _______, RESET, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
    ...
    [_MACRO] = LAYOUT(
      _______, _______, _______, _______, _______, _______,                                     _______,  _______, _______, _______,    _______,    _______,
      _______, _______, _______, _______, _______, _______,                                     _______,  _______,  _______,  _______, _______, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MOUSEJIGGLERMACRO, KC_LOCK, _______, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
     ...
     [_karjalasta] = LAYOUT(
       ...
       _______, _______,   _______,   _______,   _______,   _______, _______, _______, _______, _______, _______,   _______,   _______,   KC_DOT,  KC_SLSH, _______,
                                  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
     ),
};
